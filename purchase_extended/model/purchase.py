...
class PurchaseOrder(osv.Model):
    ...
    def wkf_draft_po(self, cr, uid, ids, context=None):
        ...
        for id in ids:
            message = _("Converted to draft Purchase Order")
            self.log(cr, uid, id, message, True, context=context)
        return self.write(cr, uid, ids, {'state': 'draftpo', 'type': 'purchase'}, context=context)
    def wkf_action_cancel(self, cr, uid, ids, context=None):
        # TODO: improve with reason
        for element in self.browse(cr, uid, ids, context=context):
            ...
            message += " " + _("cancelled")
            self.log(cr, uid, element.id, message, True, context=context)
    ...
    def bid_received_ok(self, cr, uid, ids, context=None):
        ...
        for id in ids:
            message = _("Bid received and encoded")
            self.log(cr, uid, id, message, True, context=context)
            wf_service = netsvc.LocalService("workflow")
    ...
    def print_quotation(self, cr, uid, ids, context=None):
        ...
        for id in ids:
            message = _("Request for Quotation printed")
            self.log(cr, uid, id, message, True, context=context)
