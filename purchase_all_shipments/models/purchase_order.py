...
class PurchaseOrder(models.Model):
    ...
    all_shipment_count = fields.Integer(
        'All Shipments',
        compute='_compute_all_shipment_count')

    def _compute_all_shipment_count(self):
        for rec in self:
            rec.all_shipment_count = len(rec.all_picking_ids)
