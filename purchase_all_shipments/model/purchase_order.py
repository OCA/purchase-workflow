...
class PurchaseOrder(models.Model):
    ...
    def _all_pickings(self):
        ...
        all_moves = self.env["stock.move"].search([("group_id", "in", groups.ids)])
    ...
    all_picking_ids = fields.One2many(
        "stock.picking", string="All Shipments", compute="_all_pickings"
    )
    all_shipment_count = fields.Integer("All Shipments", compute="_all_shipment_count")
