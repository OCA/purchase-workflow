...
from .common import TestQtyCommon


class TestQtyUpdate(TestQtyCommon):
    at_install = False
    post_install = True
...
class TestQtyUpdateTwoStep(TestQtyCommon):
    at_install = False
    post_install = True
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.env.ref("stock.warehouse0").reception_steps = "two_steps"
        cls.po.button_confirm()
    ...
    def test_purchase_line_qty_decrease(self):
        ...
        line1.write({"product_qty": 30})
        self.assertEqual(move1.product_uom_qty, 30)
        self.assertEqual(len(move1.move_dest_ids), 1)
        self.assertEqual(move1.move_dest_ids.product_uom_qty, 31)
