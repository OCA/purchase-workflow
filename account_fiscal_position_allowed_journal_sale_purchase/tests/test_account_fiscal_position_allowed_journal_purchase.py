...
class TestAccountFiscalPositionAllowedJournalSalePurchase(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        cls.partner_01.property_account_position_id = cls.fiscal_position_02
    ...
    def test_01(self):
        ...
        Data:
            ...
            - The invoice partner has a different fiscal position
        Test case:
            - Set the purchase order on the invoice and trigger the onchanges
        Expected result:
            - The fiscal position should still be the one set on the PO
        """
