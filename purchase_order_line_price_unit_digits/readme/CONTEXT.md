From this change https://github.com/odoo/odoo/pull/243987 , `price_unit` in purchase order
...
from the pricelists or currency conversions often throw quite a bunch of decimals
