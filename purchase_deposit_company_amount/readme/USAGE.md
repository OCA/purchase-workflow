...
The bill that carries the deposit offset has to invoice the order in full.
Posting one that leaves part of the order unbilled is refused, because the
whole deposit is relieved on that first bill and its difference would be
charged to the quantities billed first alone.
