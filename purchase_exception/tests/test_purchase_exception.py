...
class TestPurchaseException(TransactionCase):
    def setUp(self):
        ...
        self.purchase_exception_confirm = self.env["purchase.exception.confirm"]
        self.exception_noemail = self.env.ref("purchase_exception.po_excep_no_email")
        self.exception_qtycheck = self.env.ref("purchase_exception.pol_excep_qty_check")
        self.po_vals = {
