...
class StockWarehouse(models.Model):
    ...
    subcontracting_service_proc_rule_id = fields.Many2one(
        comodel_name="stock.rule", string="Subcontracting Service Procurement Rule"
    )
    ...
    def create(self, vals_list):
        warehouse_ids = super().create(vals_list)
        warehouse_ids._set_subcontracting_service_proc_rule()
