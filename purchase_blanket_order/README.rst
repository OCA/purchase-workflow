...
order expires due to either reaching the validity date or receiving all the
original agreed product quantities.
...
A new menu in the Purchase area is created, allowing users to create new blanket
orders.
