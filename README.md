...
[purchase_order_qty_change_no_recompute](purchase_order_qty_change_no_recompute/) | 16.0.1.0.0 |  | Prevent recompute if only quantity has changed in purchase order line
