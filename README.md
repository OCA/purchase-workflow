...
[purchase_last_price_info](purchase_last_price_info/) | 13.0.2.0.1 | [![LoisRForgeFlow](https://github.com/LoisRForgeFlow.png?size=30px)](https://github.com/LoisRForgeFlow) | Purchase Product Last Price Info
...
[purchase_order_supplierinfo_update](purchase_order_supplierinfo_update/) | 13.0.1.0.0 | [![ernestotejeda](https://github.com/ernestotejeda.png?size=30px)](https://github.com/ernestotejeda) | Update product supplierinfo with the last purchase price
...
[purchase_request](purchase_request/) | 13.0.4.2.0 |  | Use this module to have notification of requirements of materials and/or external services and keep track of such requirements.
...
[purchase_work_acceptance](purchase_work_acceptance/) | 13.0.1.1.1 |  | Purchase Work Acceptance
