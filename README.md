...
[purchase_invoice_plan](purchase_invoice_plan/) | 14.0.1.2.0 | [![kittiu](https://github.com/kittiu.png?size=30px)](https://github.com/kittiu) | Add to purchases order, ability to manage future invoice plan
...
[purchase_order_vendor_product](purchase_order_vendor_product/) | 14.0.1.0.0 |  | Show only products from the selected vendor in PO line
