...
[purchase_deposit](purchase_deposit/) | 10.0.1.0.0 |  | Option to create deposit from purchase order
...
[purchase_order_approved](purchase_order_approved/) | 10.0.2.0.0 |  | Add a new state 'Approved' in purchase orders.
...
[purchase_request](purchase_request/) | 10.0.1.2.2 |  | Use this module to have notification of requirements of materials and/or external services and keep track of such requirements.
...
[purchase_request_to_rfq](purchase_request_to_rfq/) | 10.0.1.1.3 |  | Purchase Request to RFQ
