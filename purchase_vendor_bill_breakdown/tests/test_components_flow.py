...
class TestComponentsFlow(PurchaseTransactionCase):
    ...
    TEST 3 - Checking field values when changing a component
    """
    ...
    def test_onchange_component_id(self):
        ...
        test_line_1 = self.purchase_order_2_test_1.order_line
        with Form(test_line_1, view=self.component_view) as form:
            with form.component_ids.new() as component:
                component.product_uom_qty = 2.0
                self.assertEqual(
                    component.product_uom_qty,
                    2,
                ...
                component.component_id = self.product_product_test_2
                self.assertEqual(
                    component.product_uom_qty,
                    1,
