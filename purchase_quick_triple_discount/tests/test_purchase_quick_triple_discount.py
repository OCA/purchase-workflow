...
class TestPurchaseQuickTripleDiscount(TransactionCase):
    ...
    def _add_seller(cls, product, prices):
        ...
        for min_qty, price, discount1, discount2, discount3 in prices:
    ...
    def setUpClass(cls):
        ...
        # {"min_qty", "price", "discount1", "discount2", "discount3"},
        cls._add_seller(
            cls.product_1,
            [
                (0, 117, 10, 2, 0),
    ...
    def test_01_supplier_discount_selection_for_po(self):
        ...
        self.assertEqual(line_1.discount1, 10)
        self.assertEqual(line_1.discount2, 2)
        self.assertEqual(line_1.discount3, 0)
