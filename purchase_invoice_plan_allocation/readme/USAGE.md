1. Open a request for quotation, tick **Use Invoice Plan**, and choose an
   **Invoice Plan Method** (*Proportional*, *Sequential Grouped*, or *Manual*).
...
5. Confirm the order, then click **Create Bill by Plan** to issue the next bill
   or all remaining bills.
