...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-purchase_line_procurement_group',
        'odoo14-addon-purchase_line_service_qty_received',
