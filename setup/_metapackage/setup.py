...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo13-addon-purchase_order_line_sequence',
        ...
        'odoo13-addon-purchase_order_product_recommendation_classification',
        ...
        'odoo13-addon-purchase_stock_tier_validation',
        'odoo13-addon-purchase_substate',
        'odoo13-addon-purchase_tier_validation',
        'odoo13-addon-purchase_tier_validation_forward',
        'odoo13-addon-purchase_triple_discount',
        'odoo13-addon-purchase_v12_control_menu',
