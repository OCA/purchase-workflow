...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo11-addon-purchase_order_product_recommendation_brand',
        ...
        'odoo11-addon-purchase_representative',
        ...
        'odoo11-addon-purchase_stock_price_unit_sync',
        'odoo11-addon-purchase_stock_return_request',
