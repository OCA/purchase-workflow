...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-product_supplierinfo_qty_multiplier>=15.0dev,<15.1dev',
        ...
        'odoo-addon-purchase_invoice_status_line>=15.0dev,<15.1dev',
        ...
        'odoo-addon-purchase_order_uninvoiced_amount_line>=15.0dev,<15.1dev',
        ...
        'odoo-addon-purchase_uninvoiced_amount_force_invoiced_line>=15.0dev,<15.1dev',
