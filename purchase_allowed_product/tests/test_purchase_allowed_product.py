...
class TestPurchaseAllowedProduct(TransactionCase):
    ...
    def set_purchase_partner(self, partner):
        ...
        self.assertEqual(
            self.purchase.use_only_supplied_product, partner.use_only_supplied_product
        )
    ...
    def set_invoice_partner(self, partner):
        ...
        # Ensure the use_only_supplied_product is set
        self.assertEqual(
            self.invoice.use_only_supplied_product, partner.use_only_supplied_product
        )
    ...
    def test_purchase_onchange(self):
        ...
        with self.env.do_in_onchange():
            ...
            self.assertEqual(self.purchase.use_only_supplied_product, True)
        context = {
            "restrict_supplier_id": self.purchase.partner_id.id,
            "use_only_supplied_product": self.purchase.use_only_supplied_product,
        }
    ...
    def test_invoice_onchange(self):
        ...
        with self.env.do_in_onchange():
            ...
            self.assertEqual(self.invoice.use_only_supplied_product, True)
        context = {
            "restrict_supplier_id": self.invoice.partner_id.id,
            "use_only_supplied_product": self.invoice.use_only_supplied_product,
        }
        supplied_product = self.product_model.with_context(context)._search([])
        self.assertEqual(
            set(supplied_product), set(self.prtner_4_supplied_products.ids)
